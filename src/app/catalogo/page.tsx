    ...
    <main style={{ background: "#f0ebe3", minHeight: "100vh" }}>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: "radial-gradient(circle at 20% 50%, #c9912a 0%, transparent 50%), radial-gradient(circle at 80% 20%, #c9912a 0%, transparent 40%)",
          }}
        />
      ...
      <a
        ...
        style={{
          background: "#c9912a",
          boxShadow: "0 4px 20px rgba(201,145,42,0.4)",
        }}
